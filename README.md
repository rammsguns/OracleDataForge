...
- Object copy from one connection to another — sequences, tables, indexes, views, materialized views, synonyms or triggers, picked object by object, tablespace optional
